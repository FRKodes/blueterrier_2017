	...
	<div class="container-fluid back-blue_1 m-b-40 p-b-20">
		<div class="row">
			<div class="container text-center">
				<h1 class="titillium blue_2">GRILL POINT</h1>
	...
	<div class="container project-detail">
		<div class="row">
			...
			<div class="images-container col-sm-10 col-sm-offset-1 col-md-8 col-md-offset-2 ">
				<figure><img src="images/grill-point-social-media-01.jpg" alt="proyecto grill point social media 01"></figure>
				<figure><img src="images/grill-point-social-media-02.jpg" alt="proyecto grill point social media 02"></figure>
				<figure><img src="images/grill-point-social-media-03.jpg" alt="proyecto grill point social media 03"></figure>
				<figure><img src="images/grill-point-social-media-04.jpg" alt="proyecto grill point social media 04"></figure>
